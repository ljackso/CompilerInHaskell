...
>                                     [(e,[])]  -> e
>                                     [(_,out)] -> error ("parse error in " ++ out)
>                                     []        -> error "parse error"
...
> condExpr                      = do c1 <- compExpr
>                                    do o  <- getCond
>                                       c2 <- compExpr
>                                       return (CondApp o c1 c2)
>                                     +++ do return c1
>                                  +++ do condFactor
   

> compExpr                      :: Parser Expr
> compExpr                      =  do n <- arthExpr
>                                     do o <- getComp              
>                                        e <- arthExpr
>                                        return (CompApp o n e)
>                                      +++ do return n 
>                                   +++ do compFactor

> getCond                       :: Parser CondOp
> getCond                       = do symbol "&&"
>                                    return (AND)
>                                  +++ do symbol "||"
>                                         return (OR)   

> getComp                       :: Parser CompOp
> getComp                       = do symbol "=="
>                                    return (EQU)
>                                  +++ do symbol "!="
>                                         return (NEQ)
...
> compFactor                    =  do symbol "("
>                                     e <- compExpr
>                                     symbol ")"
>                                     return e

> condFactor                    =  do symbol "("
>                                     e <- condExpr
>                                     symbol ")"
>                                     return e
